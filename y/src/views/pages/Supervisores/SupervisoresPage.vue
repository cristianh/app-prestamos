...
import SupervisorService from '../Supervisores/Services/SupervisorService.js';
export default {
    data() {
        return {
       register:{
    ...
    methods:{
      onSelectdEmpresa(){
        ...
        this.supervisorservice.guardarSupervisor(this.usuarioOnLogin,this.usuario.empresa,this.usuario).then( (response) =>  {
              
                var id =response.data.id;
                user.updateProfile({
                      displayName:this.usuario.nombre +" "+this.usuario.apellido+'-'+id+'-'+this.usuarioOnLogin+'-'+this.usuario.empresa+'-'+this.usuario.rol
                    }).then(function() {
                      return "actualizado";
                ...
                this.$toast.add({severity:'success', summary: 'Correcto', detail:'Supervisor ha sido guardado', life: 3000});
                this.register={
                    email:'',
                    password:''
                }
